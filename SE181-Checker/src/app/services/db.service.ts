...
export class DbService {
  ...
  public appendObjectAtPath(path: string, object): firebase.default.database.ThenableReference {
    return this.afDb.list(environment.firebasePath + path).push(object);
  }

  public pushObjectAtPath(path: string, object): firebase.default.database.ThenableReference {
  ...
  public getListSortedByFunction<T>(path: string, query): Observable<T[]> {
